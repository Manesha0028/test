...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/fJUpcBEMwn)
...
```sh
npx nx serve digitalcalm-sl
```

To create a production bundle:

```sh
npx nx build digitalcalm-sl
```

To see all available targets to run for a project, run:

```sh
npx nx show project digitalcalm-sl
```
