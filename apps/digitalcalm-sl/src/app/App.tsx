          ...
          <View style={styles.section}>
            <View style={styles.shadowBox}>
              ...
              <TouchableOpacity
                ...
                onPress={() => {
                  Linking.openURL('https://cloud.nx.app/connect/unB35PpW8i');
                }}
              >
                <Text
                  style={[
          ...
          >
            <View style={styles.shadowBox}>
              ...
              <View style={styles.codeBlock}>
                ...
                >
                  nx test DigitalcalmSl
                </Text>
                <Text style={[styles.textXS, styles.monospace, styles.comment]}>
                  # Lint
                </Text>
                <Text style={[styles.textXS, styles.monospace]}>
                  nx lint DigitalcalmSl
                </Text>
                <Text style={[styles.textXS, styles.monospace, styles.comment]}>
                  # Run them together!
                </Text>
                ...
                >
                  nx run-many -p DigitalcalmSl -t build test lint
                </Text>
              </View>
